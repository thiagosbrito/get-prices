        ...
        .directive('ngJsonExportExcel', function () {
            return {
                ...
                link: function (scope, element) {
                    scope.filename = !!scope.filename ? scope.filename : 'lista-de-precos' + moment().format('DDMMYYYYhmmss');
                    ...
                    element.bind('click', function() {
                        ...
                        var blob = new Blob([strData], {type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"});
